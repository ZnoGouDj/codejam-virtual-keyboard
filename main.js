...
const russianKb = {
    rows: [
        ...
        [
            { key: 'tab', code: 9, width: 2 },
            { key: 'й', code: 81, width: 1 },
            { key: 'ц', code: 87, width: 1 },
            { key: 'у', code: 69, width: 1 },
            { key: 'к', code: 82, width: 1 },
            { key: 'е', code: 84, width: 1 },
            { key: 'н', code: 89, width: 1 },
            { key: 'г', code: 85, width: 1 },
            { key: 'ш', code: 73, width: 1 },
            { key: 'щ', code: 79, width: 1 },
            { key: 'з', code: 80, width: 1 },
            { key: 'х', code: 219, width: 1 },
            { key: 'ъ', code: 221, width: 1 },
            { key: "\\", code: 220, width: 1 }
        ],
        [
            { key: 'caps', code: 20, width: 3 },
            { key: 'ф', code: 65, width: 1 },
            { key: 'ы', code: 83, width: 1 },
            { key: 'в', code: 68, width: 1 },
            { key: 'а', code: 70, width: 1 },
            { key: 'п', code: 71, width: 1 },
            { key: 'р', code: 72, width: 1 },
            { key: 'о', code: 74, width: 1 },
            { key: 'л', code: 75, width: 1 },
            { key: 'д', code: 76, width: 1 },
            { key: 'ж', code: 186, width: 1 },
            { key: "э", code: 222, width: 1 },
            { key: 'enter', code: 13, width: 3 }
        ],
        [
            { key: 'shift', code: 16, width: 4 },
            { key: 'я', code: 90, width: 1 },
            { key: 'ч', code: 88, width: 1 },
            { key: 'с', code: 67, width: 1 },
            { key: 'м', code: 86, width: 1 },
            { key: 'и', code: 66, width: 1 },
            { key: 'т', code: 78, width: 1 },
            { key: 'ь', code: 77, width: 1 },
            { key: 'б', code: 188, width: 1 },
            { key: 'ю', code: 190, width: 1 },
            { key: '\.', code: 191, width: 1 },
            { key: '⯅', code: 38, width: 1 },
            { key: 'shift', code: 16, width: 0 }
        ],
